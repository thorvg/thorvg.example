...
<br />
### Run
Once the build is complete, you can run each example binary directly from the builddir folder.</br>
</br>
...
```
./builddir/src/Shapes gl    # Runs with OpenGL
./builddir/src/Shapes wg    # Runs with WGPU
